...
from util.util import non_max_suppression, xywh2xyxy

def evaluate(model, dataloader, plot=False, save_dir='./run'):
    model.eval()
    decoder = BoxDecoder()
...
if __name__ == '__main__':
    ...
    tp, fp, p, r, f1, ap, ap_class = evaluate(model, dataloader, plot=True)
